...
st.caption(f"🟢 版本 {APP_VER}（2026-08-10真實事件：排班組給錯檔案——檔名寫這週，表頭日期"
           "卻是兩週前的舊資料，過去完全沒有檢查，全靠玉繡肉眼發現。新增第五輪日期核對："
           "上傳的檔案內容跟檔名/分頁名對不上這週，會跳出醒目警告並停用「產生定案」/「送稽核"
           "結果到雲端」按鈕，需勾選已核對過排班組才能繼續）· 2026-08-10")
