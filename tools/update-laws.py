...
WANT = {
    ...
    "勞工請假規則": None,
    "勞資會議實施辦法": None,
    # —— 稅務（工會／人民團體相關；大法只收重點條，免稅標準整部）——
    "所得稅法": {"4", "11", "71", "75", "88", "89", "92"},   # §4免稅·§11機關團體定義·§71結算申報·§75決清算·§88~92扣繳/憑單
    "加值型及非加值型營業稅法": {"1", "3", "8", "28", "35"},  # §1課稅範圍·§3銷售·§8免稅·§28登記·§35申報（工會若有銷售貨物勞務）
    "教育文化公益慈善機關或團體免納所得稅適用標準": None,    # 工會免稅要件，整部
    # —— 個資（整部）——
    "個人資料保護法": None,
    # —— 人身保護／騷擾防治（使用者加選）——
    "性騷擾防治法": None,
