...
WANT = {
    ...
    "勞資會議實施辦法": None,
    # —— 工會免稅要件（整部）——
    "教育文化公益慈善機關或團體免納所得稅適用標準": None,    # 工會免稅要件
    # —— 個資（整部）——
    "個人資料保護法": None,
    # —— 人身保護／騷擾防治（使用者加選）——
    "性騷擾防治法": None,
    ...
    "稅捐稽徵法": None,
    "加值型及非加值型營業稅法": None,
    "土地稅法": None,            # 土增稅、地價稅、田賦（農地農用免徵土增稅）
    "房屋稅條例": None,
    "遺產及贈與稅法": None,      # 繼承、贈與（農業用地繼承免稅）
    "契稅條例": None,            # 不動產移轉契稅
    # —— 不動產 / 土地 / 農地（使用者加選；稅務法源庫）——
    "公寓大廈管理條例": None,
    "土地法": None,             # 土地登記、租賃、地權
    "平均地權條例": None,
    "農業發展條例": None,        # 農地農用、農地買賣/分割、農地繼承免稅
    "耕地三七五減租條例": None,  # 農地租賃（三七五減租）
    "區域計畫法": None,         # 非都市土地使用分區（特定農業區＝水稻保護區之類）
    "都市計畫法": None,         # 都市土地使用分區（農業區）
...
CAT = {
    ...
    "土地稅法": "稅務", "房屋稅條例": "稅務", "遺產及贈與稅法": "稅務", "契稅條例": "稅務",
    "公寓大廈管理條例": "不動產",
    "土地法": "土地", "平均地權條例": "土地", "農業發展條例": "土地",
    "耕地三七五減租條例": "土地", "區域計畫法": "土地", "都市計畫法": "土地",
    "民法": "民事", "中華民國刑法": "刑事",
}
...
def main():
    ...
    payload = {
        ...
        "note": "官方現行條文；民法、刑法為常用條精選，其餘（含智財法群）為整部收錄。",
        "count": len(out),
        "laws": out,
    }
